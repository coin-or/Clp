...
public:
  ...
  virtual void getGrad(ClpInterior * model, CoinDenseVector &x, CoinDenseVector &grad) const;
  
  virtual void getHessian(ClpInterior * model, CoinDenseVector &x, CoinDenseVector &H) const;
  
  virtual double getObj(ClpInterior * model, CoinDenseVector &x) const;
