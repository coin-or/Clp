...
public:
  ...
  virtual void getGrad(ClpInterior * model, CoinDenseVector &x, CoinDenseVector &grad) const=0;
  
  virtual void getHessian(ClpInterior * model, CoinDenseVector &x, CoinDenseVector &H) const=0;
  
  virtual double getObj(ClpInterior * model, CoinDenseVector &x) const=0;
