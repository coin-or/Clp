...
void AbcWarmStart::setSize(int ns, int na)
{
...
void AbcWarmStart::assignBasisStatus(int ns, int na, char *&sStat,
  char *&aStat)
{
...
// Resizes
void AbcWarmStart::resize(int newNumberRows, int newNumberColumns)
{
...
*/
void AbcWarmStart::deleteRows(int rawTgtCnt, const int *rawTgts)
{
  if (rawTgtCnt <= 0)
    return;
...
// Deletes columns
void AbcWarmStart::deleteColumns(int number, const int *which)
{
