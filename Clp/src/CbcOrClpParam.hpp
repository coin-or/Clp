...

{
  ...
  CBC_PARAM_INT_MAXITBK,
  CBC_PARAM_INT_MAXITBKEXT,
  CBC_PARAM_INT_CLQEXTMETHOD,
  ...
  CBC_PARAM_STR_CLIQUEMERGING,
  CBC_PARAM_STR_BKCLIQUECUTS,
  CBC_PARAM_STR_ODDHOLEWCCUTS,
