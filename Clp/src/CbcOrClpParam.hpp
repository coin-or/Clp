...
enum CbcOrClpParameterType
  ...
  { GENERALQUERY = -100,FULLGENERALQUERY,
    ...
    THREADS,CUTPASS,VUBTRY,DENSE,EXPERIMENT,DIVEOPT,
#ifdef COIN_HAS_CBC 
    LOGLEVEL , 
#endif
    ...
    LANDPCUTS,RINS,RESIDCUTS,RENS,DIVINGA,DIVINGC,DIVINGF,DIVINGG,DIVINGL,
    DIVINGP,DIVINGV,
    ...
    OUTDUPROWS,USERCLP,MODELIN,CSVSTATISTICS,
