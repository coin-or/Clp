...
ClpPrimalColumnDantzig(), modelPE_(NULL), psi_(psi),
iCurrent_(0), iInterval_(100),
coDegenCompatibles_(0), coConsecutiveCompatibles_(0), updateCompatibles_(true)
{}
...
////-------------------------------------------------------------------
int 
ClpPEPrimalColumnDantzig::pivotColumn(CoinIndexedVector * updates,
...
*/
void
ClpPEPrimalColumnDantzig::saveWeights(ClpSimplex * model, int mode)
{
