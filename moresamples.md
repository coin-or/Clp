...
file`CLPSAMPLESDIRINSTALL\`. Below is a list of some of the most useful
sample files with a short description for each
file.
...
illustrates the performance of a given
task.
