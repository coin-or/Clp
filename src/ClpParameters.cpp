...
ClpParameters::ClpParameters() : parameters_(ClpParam::LASTPARAM) {
...
void ClpParameters::addClpActionParams() {
  ...
  parameters_[ClpParam::EITHERSIMPLEX].setup(
      "solv!e", "Solve problem using dual simplex (probably)", "Solves ",
      CoinParam::displayPriorityHigh);
...
void ClpParameters::addClpIntParams() {
  ...
  parameters_[ClpParam::DENSE].setup(
      ...
      -1,
      "If processed problem <= this use dense factorization" CoinParam::
          displayPriorityLow);
#endif
