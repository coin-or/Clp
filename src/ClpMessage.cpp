...
static Clp_message clp_us_english[] = {
  ...
  { CLP_SIMPLEX_PERTURB, 14, 2, "Perturbing problem by %g%% of %g - largest nonzero change %g ( %g%%) - largest zero change %g" },
  ...
  { CLP_IMPORT_RESULT, 27, 2, "Model was imported from %s in %g seconds" },
  ...
  { CLP_END_VALUES_PASS, 29, 2, "End of values pass after %d iterations" },
