...
enum CbcOrClpParameterType
  ...
  { GENERALQUERY = -100,FULLGENERALQUERY,
    ...
    DJFIX = 81, GAPRATIO,TIGHTENFACTOR,PRESOLVETOLERANCE,
    ...
    REALLY_SCALE,BASISIN,BASISOUT,SOLVECONTINUOUS,CLEARCUTS,VERSION,STATISTICS,DEBUG,DUMMY,

    BAB=351,MIPLIB,STRENGTHEN,
