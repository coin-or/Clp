...
enum CbcOrClpParameterType
  ...
  { GENERALQUERY = -100,FULLGENERALQUERY,
    ...
    SUBSTITUTION,DUALIZE,FPUMPITS,

    STRONGBRANCHING=151,CUTDEPTH, MAXNODES,NUMBERBEFORE,
#ifdef COIN_USE_CBC 
    LOGLEVEL , 
#endif
    ...
    TWOMIRCUTS,PREPROCESS,FPUMP,GREEDY,COMBINE,LOCALTREE,
    ...
    REALLY_SCALE,BASISIN,BASISOUT,SOLVECONTINUOUS,CLEARCUTS,VERSION,STATISTICS,
